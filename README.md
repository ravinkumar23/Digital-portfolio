...
<section id="about">
    ...
    <ul>
        <li>I'm RAVIN KUMAR R i am studing in Governemnt Arts and Science College,Valparai</li>
...
<tr>
    ...
    <td>
         SAKTHI MARTRIC HIGHER SECONDARY SCHOOL KANIYAMMOR I
    </td>
    <td>
        80%
    </td>
    ...
    <td>
        SAKTHI MARTRIC HIGHER SECONDARY SCHOOL KANIYAMMOR 
    </td>
    <td>
        82%
    </td>
...
<section id="contact">
    ...
    <h2>Contact
      ...
      3,145A
        <br>WEST street 
        <br>THENSIRVALLUR, THENSIRVALLUR 
        <br>VILLUPURAM, CHINNA SALEM606204
    </div>
</section>
